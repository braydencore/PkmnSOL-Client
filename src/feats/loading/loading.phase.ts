...
export class LoadingPhase implements IGamePhase {
  ...
  private loadImageAndSprite() {
    ...
    this.scene.loadImage(TEXTURE.WINDOW_CURSOR, 'ui/windows', 'window_cursor_solara');
    this.scene.loadImage(TEXTURE.WINDOW_CURSOR_R, 'ui/windows', 'window_cursor_r_solara');
    this.scene.loadImage(TEXTURE.WINDOW_CURSOR_Y, 'ui/windows', 'window_cursor_y_solara');
    this.scene.loadImage(TEXTURE.WINDOW_HUD, 'ui/windows', 'window_hud_solara');
    this.scene.loadImage(TEXTURE.WINDOW_NOTICE_0, 'ui/windows', 'window_notice_0_solara');
    this.scene.loadImage(TEXTURE.WINDOW_NOTICE_1, 'ui/windows', 'window_notice_1_solara');
    this.scene.loadImage(TEXTURE.WINDOW_NOTICE_2, 'ui/windows', 'window_notice_2_solara');
    this.scene.loadImage(TEXTURE.WINDOW_PC, 'ui/windows', 'window_pc_solara');
    ...
    this.scene.loadImage(TEXTURE.WINDOW_COMMON, 'ui/windows', 'window_common_solara');
    this.scene.loadImage(TEXTURE.WINDOW_UNCOMMON, 'ui/windows', 'window_uncommon_solara');
    this.scene.loadImage(TEXTURE.WINDOW_RARE, 'ui/windows', 'window_rare_solara');
    this.scene.loadImage(TEXTURE.WINDOW_SUPER_RARE, 'ui/windows', 'window_super-rare_solara');
    this.scene.loadImage(TEXTURE.WINDOW_ULTRA_RARE, 'ui/windows', 'window_ultra-rare_solara');
    this.scene.loadImage(TEXTURE.WINDOW_EPIC, 'ui/windows', 'window_epic_solara');
    this.scene.loadImage(TEXTURE.WINDOW_UNIQUE, 'ui/windows', 'window_unique_solara');
    this.scene.loadImage(TEXTURE.WINDOW_LEGENDARY, 'ui/windows', 'window_legendary_solara');
    this.scene.loadImage(TEXTURE.WINDOW_SYS, 'ui/windows', 'window_sys_solara');
